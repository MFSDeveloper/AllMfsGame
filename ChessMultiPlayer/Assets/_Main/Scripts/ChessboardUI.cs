...
namespace Chessticle
{
    public class ChessboardUI : MonoBehaviour
    {
        ...
        public GameObject MessageTextParent1;
        ...
        void Start()
        {
            ...
            HidePromotionUI();
            MessageTextParent1.gameObject.SetActive(false);
        ...
        {
            if (MessageTextParent1 != null)
            {
                MessageTextParent1.gameObject.SetActive(false); // Show the text
        ...
        public void StartGame(Color localPlayerColor)
        {
            ...
            Refresh();
            MessageTextParent1.gameObject.SetActive(true);
        }
        ...
        {
            PromotionUI.transform.SetAsLastSibling();
